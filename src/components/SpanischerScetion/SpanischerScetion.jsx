...
function SpanischerScetion() {
  const teamsData = [
    {
      id: 1,
      img: "../../../public/images/natural1.png",
      name: "LIMITED PREMIUM CAVIAR",
      designation: "CHF 290.00 – CHF 4'560.00",
      linkedin: "#",
      twitter: "#",
      instagram: "#",
    },
    {
      id: 2,
      img: "../../../public/images/natural1.png",
      name: "PREMIUM CAVIAR SMOKED",
      designation: "CHF 249.00 – CHF 3'790.00",
      linkedin: "#",
      twitter: "#",
      instagram: "#",
    },
    ...
    },
    {
      id: 4,
      img: "../../../public/images/natural1.png",
      name: "PREMIUM CAVIAR TRUFFLE",
      designation: "CHF 249.00 – CHF 3'790.00r",
      linkedin: "#",
      twitter: "#",
      instagram: "#",
    },

    {
      id: 5,
      img: "../../../public/images/natural1.png",
      name: "PREMIUM CITRUS CAVIAR",
      designation: "CHF 239.00 – CHF 3'790.00",
      linkedin: "#",
      twitter: "#",
      instagram: "#",
    },
  ...
  return (
    <div>
      <div
        style={{}}
        className=" lg:w-[80%] w-[70%]  mx-auto rounded-xl pt-[100px] pt-[70px] mt-20 bg-[url('../../../public/images/commonBg.png')] sm:pt-[150px] lg:pt-[150px] pb-[50px]"
      >
        <div className="text-center">
          <div>
            <h1 className=" text-xl  lg:text-6xl mb-20  text-white font-bold">
              APANISCHER CAVIAR
            </h1>
          </div>
        </div>
        ...
        <div className=" py-[50px] ">
          <div className="container mx-auto px-[20px] tex-center ">
            ...
            <div className="flex justify-between px-10">
              <h3 className="pt-2">Zeigt alle 5 Ergebnisse</h3>
            ...
            <div className="sflex grid justify-around  xl:grid-rows-2 lg:grid-rows-3 grid-rows-5 grid-flow-col  gap-3 container mx-auto  ">
...
export default SpanischerScetion;
